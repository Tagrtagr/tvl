...
Loss Function: RegisterTokenLoss
"""
...
class RegisterTokenLoss(nn.Module):
    """
    CURSOR IMPLEMENTATION: Loss function for Stage 2 cross-modality alignment.
    ...
    def __init__(
        ...
        """
        super(RegisterTokenLoss, self).__init__()
    ...
    def forward(
        ...
        Args:
            output_dict: Output dictionary from RegisterTokenModule.forward()
                Should contain:
