...
=======
"""
Stage 2 Loss Function: FluxTalk Register Tokens Implementation
...
Loss function for Stage 2 cross-modality alignment using register tokens.
Implements contrastive loss on overlapping tokens and regularization on complementary tokens.
"""
